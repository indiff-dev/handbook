...
「ユーザーの行動心理」に該当する課題を解決することを目指し、次を解決策に必要な成果と定義する。

共創する人々の数、対話とフィードバックの数が増えることで、「開発チームとユーザーの繋がりや関係性が薄く、エンゲージメントが低い。ユーザーとの対話と分析が不足しており、そのため、PMFを達成するプロダクトに成長することができない」という課題を解決する。 

### 1. 共創するユーザーの数

現状 | 導入後
| --- | ---
ユーザーが無関心で協力する姿勢がない。共創するユーザーは0〜2名と少ない。 | ユーザーが関心を持ち、「自分がやらなければ」と協力する姿勢になる。共創するユーザーが30名以上になり、プロダクトの成長が加速する。

### 2. 対話とフィードバックの数

現状 | 導入後
| --- | ---
対話は週に1回、フィードバックは週に0〜3件得られる。 | 対話は週に5回以上、フィードバックは週に15件以上得られる。
