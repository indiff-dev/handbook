...
はじめに、ペルソナに該当するユーザであるかどうかを確かめる。

次に、インタビューのアポイントメントを取る。その際、インタビューの背景と目的、主な聞きたいことを伝える。

> 私は今、プロダクトを開発する多くの開発チームが「ユーザとの繋がりや関係性」に、課題を抱えていると考えています。
> 「開発チームとユーザのつながりが薄い」、「開発チームとユーザの距離感が遠い」といった課題です。
> この課題が、課題検証のゴールを満たすかを確認するため、インタビューをさせてください。
> 
> このインタビューでは、最終的に次の内容をあなたからお聞きし、掘り下げたいと思っています。
>
> - **"課題が原因で発生した問題の具体的なエピソード"** と **"そのときの感情の痛み"**
> - 課題に対する **"既に行動していること"**、または **"行動したがうまくいっていないこと"**
> - 課題が及ぼした**意思決定や行動の具体的な例**
