...
特になし。そもそも、ユーザーとのつながりの薄さや対話不足にそこまで課題を感じない。
(が、この方が運営するサービスは、上位互換と感じる競合に勝てないと判断し、直近で縮小する予定である。プロダクトにユニークな強みがなく、選ばれる理由がない状態だった。実装する機能の方針も、便利だと思われるものを実装し、競合が既に提供している機能を真似ていた。「やっぱり勝てないよね、こんなもんじゃない？」といった感情に見えた。)

> その課題に対して"すでに行動している"か、あるいは"行動したがうまくいっていない"証拠があること

Formアプリを利用し、ユーザーに中規模の調査を行ったが、特に参考になる意見は得られなかった。開発チーム内の2-3人で議論するほうが建設的と感じた。的外れな意見も多く、悪口にも思えるフィードバックもあった。

> 課題が"意思決定や行動"にどれほど影響しているかがわかる

リーダーレベル、チームメンバーレベルの意思決定と行動に影響している。
よく使っているユーザーに深いインタビューを実施しており、機能や実装の方針に影響を与えている。
