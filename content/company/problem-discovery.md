...
多くの開発チームは、現状のやり方で十分できている、その必要性を感じないと考えていると推測した。この課題は、"困っているが困っていない課題"である。
...
次のアクションとして、Indie HackersやProductHuntのForum、Redditでのスレッド投稿を考えた。次の事項を懸念し、課題の重要性に気づくことができるMVPをつくり、それを見せながら課題仮説を検証するアプローチを採用することにした。
